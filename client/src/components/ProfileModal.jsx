...
import './Register.css'
const ProfileModal = ({id, closeModal}) => {
  ...
  const register = async (e) => {
      e.preventDefault()
      try {
          const response = await axios.put(`http://localhost:8000/api/users/${id}`, user,{withCredentials:true})
      ...
      <div className="row justify-content-center">
        <div className="col-12 col-sm-12 col-xl-12">
          <div className="card reg text-light">
            ...
            <div className='d-flex justify-content-end'><i className="btn text-light bi bi-x-square" onClick={()=>closeModal(false)}></i></div>
